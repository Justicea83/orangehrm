...
import { OxdCardTable, OxdButton, OxdPagination, OxdDivider, OxdText, OxdIconButton, OxdForm, OxdFormRow, OxdFormActions, OxdInputField, OxdInputGroup, OxdGrid, OxdGridItem, OxdTableFilter, } from '@ohrm/oxd';
export default {
    install: (app) => {
