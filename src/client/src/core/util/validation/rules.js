 ...
 */
import { compareTime, diffInDays, formatDate, isAfter, isBefore, isEqual, parseDate, } from '../helper/datefns';
 ...
 */
export const shouldNotExceedCharLength = function (charLength) {
...
export const validDateFormat = function (displayFormat = 'yyyy-mm-dd', dateFormat = 'yyyy-MM-dd') {
    return function (value) {
        if (!value)
            return true;
...
export const validTimeFormat = function (value) {
    if (!value)
        return true;
...
export const max = function (maxValue) {
    return function (value) {
...
export const numericOnly = function (value) {
    return (value == '' ||
        (/^\d+$/.test(value) && !Number.isNaN(parseFloat(value))) ||
        translate('general.should_be_a_numeric_value'));
};
export const digitsOnlyWithDecimalPoint = function (value) {
    return (value == '' ||
        (/^\d*\.?\d*$/.test(value) && !Number.isNaN(parseFloat(value))) ||
        translate('general.should_be_a_number'));
};
export const digitsOnlyWithDecimalPointAndMinusSign = function (value) {
    return (value == '' ||
        (/^-?\d*\.?\d*$/.test(value) && !Number.isNaN(parseFloat(value))) ||
        translate('general.should_be_a_number'));
};
 ...
 */
export const beforeDate = function (date1, date2, dateFormat = 'yyyy-MM-dd') {
 ...
 * @param {string} dateFormat
 */
export const afterDate = function (date1, date2, dateFormat = 'yyyy-MM-dd') {
    // Skip assertion on unset values
    if (!date1 || !date2) {
        return true;
    }
 ...
 * @param {string} dateFormat
 */
export const sameDate = function (date1, date2, dateFormat = 'yyyy-MM-dd') {
    // Skip assertion on unset values
    if (!date1 || !date2) {
        return true;
    }
 ...
 */
export const endDateShouldBeAfterStartDate = (startDate, message, options = {
    allowSameDate: false,
    dateFormat: 'yyyy-MM-dd',
}) => {
    return (value) => {
        const resolvedStartDate = typeof startDate === 'function' ? startDate() : startDate;
        const resolvedMessage = typeof message === 'string'
            ? message
            : translate('general.end_date_should_be_after_start_date');
        if (options.allowSameDate) {
            return (sameDate(value, resolvedStartDate) ||
                afterDate(value, resolvedStartDate, options.dateFormat) ||
                resolvedMessage);
        }
        else {
            return (afterDate(value, resolvedStartDate, options.dateFormat) ||
                resolvedMessage);
        }
    };
};
 ...
 */
export const beforeTime = function (time1, time2, timeFormat = 'yyyy-MM-dd') {
    // Skip assertion on unset values
    if (!time1 || !time2) {
        return true;
    }
 ...
 * @param {string} timeFormat
 */
export const afterTime = function (time1, time2, timeFormat = 'HH:mm') {
    // Skip assertion on unset values
    if (!time1 || !time2) {
        return true;
    }
 ...
 * @param {string} timeFormat
 */
export const sameTime = function (time1, time2, timeFormat = 'HH:mm') {
    // Skip assertion on unset values
    if (!time1 || !time2) {
        return true;
    }
 ...
 * @param {object} options
 */
export const endTimeShouldBeAfterStartTime = (startTime, message, options = {
    allowSameTime: false,
    timeFormat: 'HH:mm',
}) => {
    return (value) => {
        ...
        if (options.allowSameTime) {
            return (sameTime(value, resolvedStartTime) ||
                afterTime(value, resolvedStartTime, options.timeFormat) ||
                resolvedMessage);
        }
        else {
            return (afterTime(value, resolvedStartTime, options.timeFormat) ||
                resolvedMessage);
        }
    };
};
 ...
 */
export const maxFileSize = function (size) {
...
export const validFileTypes = function (fileTypes) {
    return function (file) {
        return (file === null ||
...
export const validEmailFormat = function (value) {
    return (!value ||
        /^[a-zA-Z0-9.!#$%&'*+\\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+$/.test(value) ||
        translate('general.expected_email_address_format_not_matched'));
};
export const validPhoneNumberFormat = function (value) {
    return (!value ||
        /^[0-9+\-/() ]+$/.test(value) ||
 ...
 * @param {object} options
 */
export const startDateShouldBeBeforeEndDate = (endDate, message, options = {
    allowSameDate: false,
    dateFormat: 'yyyy-MM-dd',
}) => {
    return (value) => {
        ...
        if (options.allowSameDate) {
            return (sameDate(value, resolvedEndDate) ||
                beforeDate(value, resolvedEndDate, options.dateFormat) ||
                resolvedMessage);
        }
        else {
            return (beforeDate(value, resolvedEndDate, options.dateFormat) ||
                resolvedMessage);
        }
    };
};
export const maxCurrency = function (maxValue) {
    return function (value) {
        return (Number.isNaN(parseFloat(value)) ||
            parseFloat(value) < maxValue ||
 ...
 * @param {object} options
 */
export const startTimeShouldBeBeforeEndTime = (endTime, message, options = {
    allowSameTime: false,
    timeFormat: 'HH:mm',
}) => {
    return (value) => {
        ...
        if (options.allowSameTime) {
            return (sameTime(value, resolvedEndTime) ||
                beforeTime(value, resolvedEndTime, options.timeFormat) ||
                resolvedMessage);
        }
        else {
            return (beforeTime(value, resolvedEndTime, options.timeFormat) ||
                resolvedMessage);
        }
    };
};
 ...
 * @param {number} charLength
 */
export const shouldNotLessThanCharLength = function (charLength) {
    return function (value) {
        return (!value ||
 ...
 * @param {string|undefined} message
 */
export const maxValueShouldBeGreaterThanMinValue = (minValue, message) => {
    return (value) => {
        const resolvedMinValue = typeof minValue === 'function' ? minValue() : minValue;
        const resolvedMessage = typeof message === 'string'
            ? message
            : translate('general.should_be_higher_than_minimum_value');
        if (resolvedMinValue === null || value === null)
            return true;
        if (resolvedMinValue === undefined || value === undefined)
            return true;
        if (resolvedMinValue === '' || value === '')
            return true;
        if (resolvedMinValue === '0' || value === '0')
            return true;
 ...
 * @param {string|undefined} message
 */
export const minValueShouldBeLowerThanMaxValue = (maxValue, message) => {
    return (value) => {
        const resolvedMaxValue = typeof maxValue === 'function' ? maxValue() : maxValue;
        const resolvedMessage = typeof message === 'string'
            ? message
            : translate('general.should_be_lower_than_maximum_value');
        if (resolvedMaxValue === null || value === null)
            return true;
        if (resolvedMaxValue === undefined || value === undefined)
            return true;
        if (resolvedMaxValue === '' || value === '0')
            return true;
 ...
 * @param {string|undefined} message
 */
export const numberShouldBeBetweenMinAndMaxValue = (minValue, maxValue, message) => {
    return (value) => {
        const resolvedMessage = typeof message === 'string'
            ? message
 ...
 * @returns {boolean|string}
 */
export const validHexFormat = function (value) {
    if (!value)
        return true;
 ...
 */
export const imageShouldHaveDimensions = function (aspectRatio, tolerance = 0.1) {
    return function (file) {
...
export const greaterThanOrEqual = function (minValue, message) {
    const resolvedMessage = typeof message === 'string'
        ? message
...
export const lessThanOrEqual = function (maxValue, message) {
    const resolvedMessage = typeof message === 'string'
        ? message
...
export const validLangString = function (value) {
    if (value === null || value === '') {
        return true;
    }
 ...
 * @returns {boolean|string}
 */
export const validSelection = function (value) {
    return typeof value === 'string' ? translate('general.invalid') : true;
};
export const validHostnameFormat = function (value) {
    let fqdnRegex;
...
export const validPortRange = function (charLength, rangeFrom, rangeTo) {
    return function (value) {
        return (!value ||
            (/^\d+$/.test(value) &&
 ...
 * @returns
 */
export const validVideoURL = function (value) {
    return (!value ||
        /^(?:https?:\/\/)?(?:m\.|www\.)?(?:youtu\.be\/|youtube\.com\/(?:shorts\/|embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(\?\S*)?$/.test(value) ||
