...
const Toaster = defineComponent({
    ...
    render() {
        return h(TransitionGroup, { appear: true, name: this.transition, tag: 'div', class: this.classes }, {
            default: () => this.toasts.map((toast, index) => {
                return h(OxdToast, {
                    key: toast.id,
                    type: toast.type,
                    title: toast.title,
...
export default {
    install: (app, options) => {
        ...
        const saveSuccess = () => success({
            title: translate('general.success'),
            message: translate('general.successfully_saved'),
        });
        const generalSuccess = (message) => success({
            title: translate('general.success'),
            message: message,
        });
