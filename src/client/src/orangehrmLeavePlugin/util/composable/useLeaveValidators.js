...
export default function useLeaveValidators(http) {
    const serializeBody = (leave) => {
        const payload = {
        ...
        if (payload.endDuration?.type !== 'specify_time' &&
    ...
    const validateOverlapLeaves = (leaveData) => {
    ...
    const validateLeaveBalance = (leaveData) => {
        return new Promise((resolve, reject) => {
            http
                .request({
                method: 'GET',
...
//# sourceMappingURL=useLeaveValidators.js.map